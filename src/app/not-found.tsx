...
export default function NotFound() {
  return (
    <div className="text-foreground min-h-[87dvh]  w-full flex items-center justify-center bg-background prose-headings:font-heading prose-h1:md:text-5xl prose-h1:text-3xl">
      <div className="flex flex-col items-center text-center max-w-(--breakpoint-xl) px-5">
        <h1 className="leading-normal text-2xl sm:text-4xl">404 Not Found</h1>
